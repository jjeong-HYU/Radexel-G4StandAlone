...
export G4LIB="`cd $geant4make_root/../../../lib/Geant4-11.1.1 > /dev/null ; pwd`"
...
# Resource file paths
# - Datasets
export G4NEUTRONHPDATA="`cd $geant4make_root/../../../../data-g4/G4NDL4.7 > /dev/null ; pwd`"
export G4LEDATA="`cd $geant4make_root/../../../../data-g4/G4EMLOW8.2 > /dev/null ; pwd`"
export G4LEVELGAMMADATA="`cd $geant4make_root/../../../../data-g4/PhotonEvaporation5.7 > /dev/null ; pwd`"
export G4RADIOACTIVEDATA="`cd $geant4make_root/../../../../data-g4/RadioactiveDecay5.6 > /dev/null ; pwd`"
export G4PARTICLEXSDATA="`cd $geant4make_root/../../../../data-g4/G4PARTICLEXS4.0 > /dev/null ; pwd`"
export G4PIIDATA="`cd $geant4make_root/../../../../data-g4/G4PII1.3 > /dev/null ; pwd`"
export G4REALSURFACEDATA="`cd $geant4make_root/../../../../data-g4/RealSurface2.2 > /dev/null ; pwd`"
export G4SAIDXSDATA="`cd $geant4make_root/../../../../data-g4/G4SAIDDATA2.0 > /dev/null ; pwd`"
export G4ABLADATA="`cd $geant4make_root/../../../../data-g4/G4ABLA3.1 > /dev/null ; pwd`"
export G4INCLDATA="`cd $geant4make_root/../../../../data-g4/G4INCL1.0 > /dev/null ; pwd`"
export G4ENSDFSTATEDATA="`cd $geant4make_root/../../../../data-g4/G4ENSDFSTATE2.3 > /dev/null ; pwd`"
...
#
# USING SYSTEM CLHEP
export CLHEP_BASE_DIR=/home/g4test/Geant4.11.1.p01/install-clhep
export CLHEP_INCLUDE_DIR=/home/g4test/Geant4.11.1.p01/install-clhep/include
export CLHEP_LIB_DIR=/home/g4test/Geant4.11.1.p01/install-clhep/lib
